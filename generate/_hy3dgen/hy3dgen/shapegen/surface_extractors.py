...
class MCSurfaceExtractor(SurfaceExtractor):
    def run(self, grid_logit, *, mc_level, bounds, octree_resolution, **kwargs):
        # Optimización CPU: Intentamos usar PyMCubes (C++ multithread) si está instalado
        try:
            import mcubes
            grid_np = grid_logit.cpu().numpy()
            vertices, faces = mcubes.marching_cubes(grid_np, mc_level)
        except ImportError:
            # Si no está instalado PyMCubes, regresa a scikit-image original
