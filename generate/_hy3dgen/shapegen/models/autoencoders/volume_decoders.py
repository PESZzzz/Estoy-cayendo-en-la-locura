...
def extract_near_surface_volume_fn(input_tensor: torch.Tensor, alpha: float):
    ...
    # Destruimos 'val' original para liberar espacio antes del stack
    del val
    ...
    # Limpieza masiva de direcciones intermedias
...
class VanillaVolumeDecoder:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # [OPTIMIZACIÓN]: Pre-asignamos el tensor final vacío. Adiós al torch.cat() y sus picos del 200% de VRAM.
        ...
        for start in tqdm(range(0, total_points, num_chunks), desc=f"Volume Decoding",
            ...
            # Limpiamos los fragmentos instantáneamente
            del chunk_queries
            del logits
    ...
    def __call__(
        ...
        **kwargs,
        ...
        for octree_depth_now in resolutions[1:]:
            ...
            # [OPTIMIZACIÓN]: Segunda pre-asignación para evitar los appends al decodificar la jerarquía
...
class FlashVDMVolumeDecoding:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # [OPTIMIZACIÓN]: Otra vez reemplazamos la dependencia extrema de memoria
        ...
        for octree_depth_now in resolutions[1:]:
            ...
            # [OPTIMIZACIÓN]: Evitamos generar la lista logits_grid_list enorme
            start_num = 0
            sum_num = 0
            for grid_index, count in zip(unique_values[0].cpu().tolist(), unique_values[1].cpu().tolist()):
                if sum_num + count < num_chunks or sum_num == 0:
                    ...
                    # Insertamos directo en la posición en lugar de concatenar después
